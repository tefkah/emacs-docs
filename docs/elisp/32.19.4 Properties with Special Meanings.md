...
This specifies a specific pointer shape when the mouse pointer is over this text or image. See [Pointer Shape](/docs/elisp/Pointer-Shape), for possible pointer shapes.
