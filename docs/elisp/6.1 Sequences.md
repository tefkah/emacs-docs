...
See [Definition of safe-length](Definition-of-safe_002dlength), for the related function `safe-length`.
...
This function generalizes `aref` (see [Array Functions](Array-Functions)) and `nth` (see [Definition of nth](Definition-of-nth)).
