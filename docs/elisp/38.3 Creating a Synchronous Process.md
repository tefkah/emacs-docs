...
### <span className="tag (:filefile-name)">`(:file file-name)`</span>``
...
[^1]: On other systems, Emacs uses a Lisp emulation of `ls`; see [Contents of Directories](Contents-of-Directories).
