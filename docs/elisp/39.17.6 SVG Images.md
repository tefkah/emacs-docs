...
### <span className="tag :stroke-width">`:stroke-width`</span>``

The default width (in pixels) of any lines created.

### <span className="tag :stroke">`:stroke`</span>``
...
### <span className="tag :stroke-color">`:stroke-color`</span>``

The color of lines drawn, and outlines around solid shapes.

### <span className="tag :fill-color">`:fill-color`</span>``
...
### <span className="tag :gradient">`:gradient`</span>``

If given, this should be the identifier of a previously defined gradient object.

### <span className="tag :clip-path">`:clip-path`</span>``
...
### <span className="tag :x-axis-rotation">`:x-axis-rotation`</span>``
...
### <span className="tag :large-arc">`:large-arc`</span>``
...
### <span className="tag :sweep">`:sweep`</span>``
